...
@section('content')
  <div class="main">
    <div class="section-title">
      <span>Proveedor - Nuevo</span>
    </div>
    <div class="main-body">
      <form class="form-project" action="/admin/proveedor_nuevo" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="div-left">
          <div class="div-top">
            ...
            <div class="input-div {{ $errors->has('name') ? ' has-error' : '' }}" id="name">
              ...
              <input class="input-product" type="text" name="name" value="{{ old('name') }}" autofocus>
              @if ($errors->has('name'))
                <span class="errors">
          ...
          <div class="div-bottom">
            ...
            <div class="input-div {{ $errors->has('address') ? ' has-error' : '' }}">
              ...
              <input class="input-product short-input" type="text" name="address" id="address" value="{{ old('address') }}">
            ...
            <div class="input-div {{ $errors->has('cp') ? ' has-error' : '' }}">
              ...
              <input class="input-product short-input" type="text" name="cp" id="cp" value="{{ old('cp') }}">
              @if ($errors->has('cp'))
                <span class="errors">
            ...
            <div class="input-div {{ $errors->has('phone') ? ' has-error' : '' }}">
              ...
              <input class="input-product short-input" type="text" name="phone" id="phone" value="{{ old('phone') }}">
              @if ($errors->has('phone'))
                <span class="errors">
          ...
          <div class="div-bottom">
            ...
            <div class="input-div {{ $errors->has('email') ? ' has-error' : '' }}">
              ...
              <input class="input-product short-input" type="text" name="email" id="email" value="{{ old('email') }}">
              @if ($errors->has('email'))
                <span class="errors">
            ...
            <div class="input-div {{ $errors->has('cuit') ? ' has-error' : '' }}">
              ...
              <input class="input-product short-input" type="text" name="cuit" id="cuit" value="{{ old('cuit') }}">
              @if ($errors->has('cuit'))
                <span class="errors">
            ...
            <div class="input-div {{ $errors->has('open') ? ' has-error' : '' }}">
              ...
              <input class="input-product short-input" type="text" name="open" id="open" value="{{ old('open') }}">
              @if ($errors->has('open'))
                <span class="errors">
