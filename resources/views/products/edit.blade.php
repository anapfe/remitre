...
@section('content')
  <div class="main">
    ...
    <form class="form-product" action="/admin/producto_editar/{{ $product->id }}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
      {{ method_field('patch') }}
      <div class="flex full-width">
        ...
        <div class="input-div div-right {{ $errors->has('models') ? ' has-error' : '' }}" id="mmodels">
          ...
          <textarea class="input-textarea" name="models" value="{{ $product->models }}">{{ $product->models }}</textarea>
